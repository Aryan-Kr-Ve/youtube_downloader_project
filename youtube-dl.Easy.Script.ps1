...
# ----------------------------------- IMPORTANT STUFF -----------------------------------------
#
# Direct link to latest youtube-dl executable: https://github.com/yt-dlp/yt-dlp/releases
...
Write-Output ""
Write-Output 'ffmpeg/builds/: https://www.gyan.dev/ffmpeg/builds/'
Write-Output 'Direct link to latest youtube-dl executable: https://github.com/yt-dlp/yt-dlp/releases'
Write-Output ""
...
while ($confirm -ne "y") {
	...
	Write-Output "7. -update yt-dlp.exe (Admin May Be Required)"
	Write-Output ""
